...
public final class ProtectionMessages {
    ...
    public enum Text {
        ...
        REGION_NAME_INVALID("Region names must be 1–32 characters using a-z, 0-9, '_' or '-'.", NamedTextColor.RED),
        REGION_NAME_RESERVED("'%s' is reserved and cannot be claimed.", NamedTextColor.RED),
        WORLD_REQUIRED("This command needs a world: /region <subcommand> ... <world>.", NamedTextColor.RED),
        ...
        USAGE_SELECT_SYNTAX("/region select <name> [world]", NamedTextColor.GRAY),
        USAGE_SELECT_DESCRIPTION("Restore a region's outline onto your selection.", NamedTextColor.GRAY),
        USAGE_SET_PARENT_SYNTAX("/region setparent <child> <parent> [world]", NamedTextColor.GRAY),
        USAGE_SET_PARENT_DESCRIPTION("Nest one region as a sub-region of another.", NamedTextColor.GRAY),
        USAGE_UNSET_PARENT_SYNTAX("/region unsetparent <child> [world]", NamedTextColor.GRAY),
        USAGE_UNSET_PARENT_DESCRIPTION("Promote a sub-region back to top-level.", NamedTextColor.GRAY),
        USAGE_MEMBER_SYNTAX("/region %s <name> <player|group:<name>> [world]", NamedTextColor.GRAY),
        ...
        USAGE_MANAGER_SYNTAX("/region %s <name> <player|group:<name>> [world]", NamedTextColor.GRAY),
        ...
        USAGE_FLAG_SYNTAX("/region flag <name> <flag> [true|false|materials...] [world]", NamedTextColor.GRAY),
