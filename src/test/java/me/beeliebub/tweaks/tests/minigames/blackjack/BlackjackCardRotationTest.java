...
/**
 * Regression tests for {@link BlackjackRenderer#flatCardRotationForFacing(BlockFace)}.
 *
 ...
 *
 * <p>{@code flatCardRotationForFacing} is public, so this test lives in the standard
 * {@code tests.minigames.blackjack} mirror package rather than the production package.
 */
class BlackjackCardRotationTest {
    ...
    void allFacingsLieFlat_normalPointsUp(BlockFace facing) {
        Quaternionf rotation = BlackjackRenderer.flatCardRotationForFacing(facing);
    ...
    void southCardTopPointsTowardNegativeZ() {
        ...
        Quaternionf rotation = BlackjackRenderer.flatCardRotationForFacing(BlockFace.SOUTH);
    ...
    void northCardTopPointsTowardPositiveZ() {
        ...
        Quaternionf rotation = BlackjackRenderer.flatCardRotationForFacing(BlockFace.NORTH);
        Vector3f top = rotation.transform(topEdge());
        assertVecEquals(new Vector3f(0f, 0f, 1f), top,
    ...
    void westCardTopPointsTowardPositiveX() {
        ...
        Quaternionf rotation = BlackjackRenderer.flatCardRotationForFacing(BlockFace.WEST);
        Vector3f top = rotation.transform(topEdge());
    ...
    void eastCardTopPointsTowardNegativeX() {
        ...
        Quaternionf rotation = BlackjackRenderer.flatCardRotationForFacing(BlockFace.EAST);
        Vector3f top = rotation.transform(topEdge());
        assertVecEquals(new Vector3f(-1f, 0f, 0f), top,
    ...
    void northAndSouthAreSpun180AboutVertical() {
        ...
        // its own seat.
        Quaternionf south = BlackjackRenderer.flatCardRotationForFacing(BlockFace.SOUTH);
        Quaternionf north = BlackjackRenderer.flatCardRotationForFacing(BlockFace.NORTH);
    ...
    void eastAndWestAreSpun180AboutVertical() {
        ...
        Quaternionf east = BlackjackRenderer.flatCardRotationForFacing(BlockFace.EAST);
        Quaternionf west = BlackjackRenderer.flatCardRotationForFacing(BlockFace.WEST);
        Quaternionf worldYHalfTurn = new Quaternionf().rotateY((float) Math.PI);
