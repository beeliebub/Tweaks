...
public final class ConfigRegistry {
    ...
    private static final List<ConfigCategory> CATEGORIES = List.of(
            ...
            new ConfigCategory("xp", "Experience", List.of(
                    ConfigSetting.of("xp.mob-drops.remove", "xp.mob-drops.remove",
                            "Remove Mob XP", EditorType.BOOLEAN),
                    ConfigSetting.of("xp.custom-drops.enabled", "xp.custom-drops.enabled",
                            "Custom XP Drops", EditorType.BOOLEAN),
                    ConfigSetting.bounded("xp.custom-drops.amount", "xp.custom-drops.amount",
                            "Custom XP Amount", EditorType.INT, 0, 1000),
                    ConfigSetting.bounded("xp.custom-drops.crop-chance-percent", "xp.custom-drops.crop-chance-percent",
                            "Crop XP Chance", EditorType.PERCENT, 0, 100),
                    ConfigSetting.bounded("xp.custom-drops.leaf-break-chance-percent", "xp.custom-drops.leaf-break-chance-percent",
                            "Leaf Break XP Chance", EditorType.PERCENT, 0, 100),
                    ConfigSetting.bounded("xp.custom-drops.leaf-decay-chance-percent", "xp.custom-drops.leaf-decay-chance-percent",
                            "Leaf Decay XP Chance", EditorType.PERCENT, 0, 100),
                    ConfigSetting.bounded("xp.custom-drops.stone-chance-percent", "xp.custom-drops.stone-chance-percent",
                            "Stone XP Chance", EditorType.PERCENT, 0, 100),
                    ConfigSetting.of("xp.custom-drops.stone-materials", "xp.custom-drops.stone-materials",
                            "Stone XP Materials", EditorType.MATERIAL_LIST),
                    ConfigSetting.of("xp.custom-drops.leaf-materials", "xp.custom-drops.leaf-materials",
                            "Leaf XP Materials", EditorType.MATERIAL_LIST),
                    ConfigSetting.bounded("xp.custom-drops.taint-ttl-days", "xp.custom-drops.taint-ttl-days",
                            "XP Taint TTL Days", EditorType.INT, 1, 3650),
                    ConfigSetting.of("xp.mending.enabled", "xp.mending.enabled",
                            "Mending Payout", EditorType.BOOLEAN),
                    ConfigSetting.bounded("xp.mending.dollars-per-xp", "xp.mending.dollars-per-xp",
                            "Dollars Per XP", EditorType.INT, 0, 1000),
                    ConfigSetting.of("xp.mending.enchantment-key", "xp.mending.enchantment-key",
                            "Mending Enchantment Key", EditorType.NAMESPACED_KEY)
            )),
            new ConfigCategory("tools", "Tools", List.of(
                    ConfigSetting.of("tools.augments.enabled", "tools.augments.enabled",
                            "Augments Enabled", EditorType.BOOLEAN),
                    ConfigSetting.of("tools.augments.gem-material", "tools.augments.gem-material",
                            "Augment Gem Material", EditorType.MATERIAL),
                    ConfigSetting.of("tools.augments.gem-item-model", "tools.augments.gem-item-model",
                            "Augment Gem Item Model", EditorType.NAMESPACED_KEY),
                    ConfigSetting.of("tools.augments.slot-prices", "tools.augments.slot-prices",
                            "Augment Slot Prices", EditorType.NUMBER_MAP),
                    ConfigSetting.of("tools.augments.slot-capacity", "tools.augments.slot-capacity",
                            "Augment Slot Capacity", EditorType.NUMBER_MAP),
                    ConfigSetting.bounded("tools.augments.slot-capacity-default", "tools.augments.slot-capacity-default",
                            "Default Augment Capacity", EditorType.INT, 0, 64),
                    ConfigSetting.of("tools.augments.quality-slot-cost", "tools.augments.quality-slot-cost",
                            "Quality Slot Costs", EditorType.NUMBER_MAP),
                    ConfigSetting.of("tools.augments.enforce-vanilla-exclusivity", "tools.augments.enforce-vanilla-exclusivity",
                            "Enforce Vanilla Exclusivity", EditorType.BOOLEAN),
                    ConfigSetting.of("tools.augments.convert-enchanted-books", "tools.augments.convert-enchanted-books",
                            "Convert Enchanted Books", EditorType.BOOLEAN),
                    ConfigSetting.of("tools.repair-kit.enabled", "tools.repair-kit.enabled",
                            "Repair Kits Enabled", EditorType.BOOLEAN),
                    ConfigSetting.of("tools.repair-kit.material", "tools.repair-kit.material",
                            "Repair Kit Material", EditorType.MATERIAL),
                    ConfigSetting.of("tools.repair-kit.item-model", "tools.repair-kit.item-model",
                            "Repair Kit Item Model", EditorType.NAMESPACED_KEY),
                    ConfigSetting.bounded("tools.repair-kit.durability-multiplier", "tools.repair-kit.durability-multiplier",
                            "Durability Multiplier", EditorType.DOUBLE, 1.0, 10.0),
                    ConfigSetting.bounded("tools.repair-kit.max-tier", "tools.repair-kit.max-tier",
                            "Maximum Repair Tier", EditorType.INT, 1, 20),
                    ConfigSetting.bounded("tools.repair-kit.tier-step-percent", "tools.repair-kit.tier-step-percent",
                            "Repair Tier Step", EditorType.PERCENT, 1, 50),
                    ConfigSetting.of("tools.repair-kit.recipe", "tools.repair-kit.recipe",
                            "Repair Kit Recipe", EditorType.MATERIAL_GRID),
                    ConfigSetting.of("tools.repair-kit.recipe-shapeless", "tools.repair-kit.recipe-shapeless",
                            "Shapeless Repair Kit Recipe", EditorType.BOOLEAN),
                    ConfigSetting.of("tools.never-break.enabled", "tools.never-break.enabled",
                            "Never Break Items", EditorType.BOOLEAN),
                    ConfigSetting.of("tools.anvil.lockout-enabled", "tools.anvil.lockout-enabled",
                            "Anvil Lockout", EditorType.BOOLEAN),
                    ConfigSetting.of("tools.anvil.grindstone-lockout-enabled", "tools.anvil.grindstone-lockout-enabled",
                            "Grindstone Lockout", EditorType.BOOLEAN),
                    ConfigSetting.of("tools.rename.enabled", "tools.rename.enabled",
                            "Rename Enabled", EditorType.BOOLEAN),
                    ConfigSetting.bounded("tools.rename.max-length", "tools.rename.max-length",
                            "Rename Max Length", EditorType.INT, 1, 256),
                    ConfigSetting.of("tools.cash-item.enabled", "tools.cash-item.enabled",
                            "Cash Items Enabled", EditorType.BOOLEAN),
                    ConfigSetting.of("tools.cash-item.pdc-key", "tools.cash-item.pdc-key",
                            "Cash PDC Key", EditorType.STRING)
            )),
