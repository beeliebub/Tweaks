...
/**
 * Unit tests for {@link BlackjackTableStore#serializeTable} and
 * {@link BlackjackTableStore#deserializeTable}.
 *
 * <p>Placed in the production package so that package-private access to the
 * static helpers and the {@link BlackjackTableStore.TableEntry} record is legal
...
class BlackjackTableStoreTest {
    ...
    void roundTripPreservesAllFields() {
        ...
        String serialized = BlackjackTableStore.serializeTable(center, bet, middleButton, BlockFace.NORTH, null);
        BlackjackTableStore.TableEntry entry = BlackjackTableStore.deserializeTable(serialized);
    ...
    void integerCoordinatesRoundTrip() {
        ...
        String serialized = BlackjackTableStore.serializeTable(center, 100, middleButton, BlockFace.SOUTH, null);
        BlackjackTableStore.TableEntry entry = BlackjackTableStore.deserializeTable(serialized);
    ...
    void halfBlockCentreCoordinatesRoundTrip() {
        ...
        String serialized = BlackjackTableStore.serializeTable(center, 50, middleButton, BlockFace.EAST, null);
        BlackjackTableStore.TableEntry entry = BlackjackTableStore.deserializeTable(serialized);
    ...
    void serializedFormatIsCorrectPipeDelimitedString() {
        ...
        String serialized = BlackjackTableStore.serializeTable(center, 10, middleButton, BlockFace.WEST, null);
    ...
    void allFourCardinalFacingsRoundTrip() {
        ...
        for (BlockFace face : new BlockFace[]{BlockFace.NORTH, BlockFace.SOUTH, BlockFace.EAST, BlockFace.WEST}) {
            String serialized = BlackjackTableStore.serializeTable(center, 100, btn, face, null);
            BlackjackTableStore.TableEntry entry = BlackjackTableStore.deserializeTable(serialized);
    ...
    void tooFewPartsReturnsNull() {
        ...
        assertNull(BlackjackTableStore.deserializeTable("world|10.0|65.0|20.0|100"),
    ...
    void unknownWorldReturnsNull() {
        ...
        assertNull(BlackjackTableStore.deserializeTable("missingworld|10.5|65.0|0.0|100|10|65|0|NORTH"),
    ...
    void pipeInWorldNameDocumentedBehaviour() {
        ...
        BlackjackTableStore.TableEntry entry = BlackjackTableStore.deserializeTable(weird);
    ...
    void backColorRoundTrips() {
        ...
        String serialized = BlackjackTableStore.serializeTable(center, 100, middleButton, BlockFace.NORTH, backColor);
        BlackjackTableStore.TableEntry entry = BlackjackTableStore.deserializeTable(serialized);
    ...
    void serializedFormatWithBackColorHasTenParts() {
        ...
        String serialized = BlackjackTableStore.serializeTable(center, 50, middleButton, BlockFace.SOUTH, 0x0000FF);
        String[] parts = serialized.split("\\|", -1);
    ...
    void legacyNineFieldStringDeserializesWithNullBackColor() {
        ...
        BlackjackTableStore.TableEntry entry = BlackjackTableStore.deserializeTable(legacy);
    ...
    void tablesInDifferentWorldsResolveToCorrectWorld() {
        ...
        String sAlpha = BlackjackTableStore.serializeTable(new Location(alpha, 1.0, 64.0, 1.0), 10, btnAlpha, BlockFace.NORTH, null);
        String sBeta  = BlackjackTableStore.serializeTable(new Location(beta,  2.0, 64.0, 2.0), 20, btnBeta,  BlockFace.SOUTH, null);

        BlackjackTableStore.TableEntry eAlpha = BlackjackTableStore.deserializeTable(sAlpha);
        BlackjackTableStore.TableEntry eBeta  = BlackjackTableStore.deserializeTable(sBeta);
